 ...
 */
export class MonetaryUtil {

    /**
     * Converts a number to its written word representation.
     * @param number - The number to convert (e.g. 100)
     * @param lang - The language code (default 'en')
     * @returns The written string (e.g. "one hundred")
     */
    static toWords(number: number, lang: string = 'en'): string {
